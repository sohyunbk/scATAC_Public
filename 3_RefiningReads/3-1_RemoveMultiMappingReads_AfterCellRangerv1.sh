...
#SBATCH --output=/scratch/sb14489/0.log/3_RemoveMultiMappingReads.%j.out   # Standard output log
#SBATCH --error=/scratch/sb14489/0.log/3_RemoveMultiMappingReads.%j.err    # Standard error log
