...
cd $Path
#mkdir -p Maize_B73_V5_withMtPt_scATACCellRangerv1
module load CellRanger-ATAC/1.2.0
cellranger-atac mkref Maize_B73_V5_withMtPt_scATACCellRangerv1 --config=CellRangerv1-ATAC_Maizev5.config ## In protocl they are saying it should be gtf but gff seems fine in v1 but in v2 it should be gtf
